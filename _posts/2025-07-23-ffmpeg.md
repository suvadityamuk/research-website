...
description: "A practical guide to FFmpeg for ML engineers — covering video conversion, trimming, frame extraction, Gaussian blur, downscaling, concatenation, and CUDA acceleration."
tags:
  - ffmpeg
  - vision
  - bash
