...
description: "My open-source contributions to Keras.io, including implementations of the Forward-Forward algorithm, Temporal Latent Bottleneck, FCN segmentation, and EEG classification."
tags:
  - keras
  - tensorflow
  - open source
